...
void        AliAnalysisTaskPhiCount::UserCreateOutputObjects()                  {
    ...
    fQC_Kaons_SigmaTPC_VETO_PT  = new TH2F("fQC_Kaons_SigmaTPC_VETO_PT","TOF Response",                                 1000, 0., 10., 100, -10, 10);
    fQC_Kaons_SigmaTPC_VETO_P   = new TH2F("fQC_Kaons_SigmaTPC_VETO_P", "TOF Response",                                 1000, 0., 10., 100, -10, 10);
    fQC_Kaons_SigmaTPC_P        = new TH2F("fQC_Kaons_SigmaTPC_P",      "TOF Response",                                 1000, 0., 10., 100, -10, 10);
    fQC_Kaons_SigmaTPC_PT       = new TH2F("fQC_Kaons_SigmaTPC_PT",     "TOF Response",                                 1000, 0., 10., 100, -10, 10);
    fQC_Kaons_SigmaTOF_P        = new TH2F("fQC_Kaons_SigmaTOF_P",      "TOF Response",                                 1000, 0., 10., 100, -10, 10);
    fQC_Kaons_SigmaTOF_PT       = new TH2F("fQC_Kaons_SigmaTOF_PT",     "TOF Response",                                 1000, 0., 10., 100, -10, 10);
